...
public class SurveyScores : SurveyItem
{
    ...
    public override void Initiate(string _name, ItemType _type, Survey _survey, string _code)
    {
        ...
        AddChoice(new Choice("sameUser", "Play Again!\n(Same user)", ButtonType.Survey, ColorBlock.defaultColorBlock.normalColor), buttonPanel.transform);
        AddChoice(new Choice("newUser", "Play Again!\n(New user)", ButtonType.Survey, ColorBlock.defaultColorBlock.normalColor), buttonPanel.transform);
